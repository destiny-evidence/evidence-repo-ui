...
import {
  countCodedAnnotations,
  enrichmentRequestsEnabled,
} from "@/components/enrichment/enrichmentRequestsEnabled";
          ...
          footer={
            enrichmentRequestsEnabled(community, investigation) && (
              <EnrichmentRequestPanel
                ...
                codedAnnotations={countCodedAnnotations(investigation)}
              />
            )
          }
        />
